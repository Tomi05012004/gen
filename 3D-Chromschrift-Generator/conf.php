...
class conf
{
  ...
  public static $newMail;
    ...
    ZB.: individuelle Firmenlogoherstellung, Anbringung der Schriftzeichen auf Trägerfolien inkl. \"Wahre Länge\"
    oder Kennzeichenhalter mit Ihrem vorgegebenen Text.
    
    Ebenso können, vom Kunden bestellte und bereits bezahlte, individuell hergestellte Grabbeschriftung und Metallbeschriftung
    nicht zurückgegeben oder geändert werden!
    Zur veranschaulichung unserer Herstellmethode und Qualität gelten die Beispielbilder, wie sie im Bestell-Generator zu sehen sind.";
